...
export const clients: Client[] = [
  ...
  { name: "EPM", logo: "/clients/2026/epm.webp", width: 228 },
  { name: "Confía", logo: "/clients/2026/confia.webp", width: 276, surface: "dark" },
  { name: "Alcaldía de Medellín", logo: "/clients/2026/alcaldia-medellin.webp", width: 278, surface: "dark" },
  { name: "Comfacundi", logo: "/clients/2026/comfacundi.webp", width: 236, scale: 0.62 },
  { name: "Cajamag", logo: "/clients/2026/cajamag.webp", width: 270 },
  { name: "Universidad Autónoma de Manizales", logo: "/clients/2026/uam.svg", width: 248, surface: "dark" },
  { name: "Greater Medellín Convention & Visitors Bureau", logo: "/clients/2026/greater-medellin.webp", width: 278 },
  { name: "Auros", logo: "/clients/2026/auros.webp", width: 270 },
  { name: "Grupo Sura", logo: "/clients/2026/grupo-sura.webp", width: 260 },
  { name: "Comfaboy", logo: "/clients/2026/comfaboy.webp", width: 270 },
  { name: "Imcolmédica", logo: "/clients/2026/imcolmedica.webp", width: 286 },
  { name: "Alcaldía Mayor de Tunja", logo: "/clients/2026/alcaldia-tunja.webp", width: 270, surface: "dark" },
  { name: "Comfenalco Antioquia", logo: "/clients/2026/comfenalco-antioquia.webp", width: 268 },
  { name: "Suplemédicos", logo: "/clients/2026/suplemedicos.webp", width: 286 },
  { name: "Guillermo Rhenals", logo: "/clients/2026/guillermo-rhenals.webp", width: 150 },
  { name: "Bogotá", logo: "/clients/2026/bogota.webp", width: 278, surface: "dark" },
  { name: "Comfandi", logo: "/clients/2026/comfandi.webp", width: 276 },
  { name: "AmCham Colombia", logo: "/clients/2026/amcham-colombia.webp", width: 270, surface: "dark" },
];

const experienceClients: Client[] = [
  { name: "Guillermo Rhenals", logo: "/experience-logos/salud/01.webp", width: 220 },
  { name: "Grupo Sura", logo: "/experience-logos/salud/02.webp", width: 220 },
  { name: "Imcolmédica", logo: "/experience-logos/salud/03.webp", width: 220 },
  { name: "Suplemédicos", logo: "/experience-logos/salud/04.webp", width: 220 },
  { name: "Atenea", logo: "/experience-logos/salud/05.webp", width: 220, surface: "dark" },
  { name: "Comfaboy", logo: "/experience-logos/cajas-compensacion/01.webp", width: 220 },
  { name: "Cajamag", logo: "/experience-logos/cajas-compensacion/02.webp", width: 220 },
  { name: "Comfenalco Antioquia", logo: "/experience-logos/cajas-compensacion/03.webp", width: 220 },
  { name: "Comfandi", logo: "/experience-logos/cajas-compensacion/04.webp", width: 220 },
  { name: "Comfacundi", logo: "/experience-logos/cajas-compensacion/05.webp", width: 220 },
  { name: "AmCham Colombia", logo: "/experience-logos/sector-publico/01.webp", width: 220, surface: "dark" },
  { name: "Alcaldía de Medellín", logo: "/experience-logos/sector-publico/02.webp", width: 220, surface: "dark" },
  { name: "Alcaldía Mayor de Tunja", logo: "/experience-logos/sector-publico/03.webp", width: 220, surface: "dark" },
  { name: "Alcaldía Mayor de Bogotá", logo: "/experience-logos/sector-publico/04.webp", width: 220, surface: "dark" },
  { name: "Sixteen Travel", logo: "/experience-logos/turismo/01.webp", width: 220, surface: "dark" },
  { name: "Viajes y Viajes", logo: "/experience-logos/turismo/02.webp", width: 220, surface: "dark" },
  { name: "Reserve Ahora", logo: "/experience-logos/turismo/03.webp", width: 220 },
  { name: "Geoser", logo: "/experience-logos/turismo/04.webp", width: 220, surface: "dark" },
  { name: "StudyNow", logo: "/experience-logos/educacion/01.webp", width: 220 },
  { name: "Universidad de Antioquia", logo: "/experience-logos/educacion/02.webp", width: 220, surface: "dark" },
  { name: "Universidad Nacional de Colombia", logo: "/experience-logos/educacion/03.webp", width: 220, surface: "dark" },
  { name: "Tecnológico de Artes Débora Arango", logo: "/experience-logos/educacion/04.webp", width: 220 },
  { name: "Universidad Autónoma de Manizales", logo: "/experience-logos/educacion/05.webp", width: 220 },
  { name: "Politécnico PIO", logo: "/experience-logos/educacion/06.webp", width: 220 },
  { name: "AKUO Operación de Equipos", logo: "/experience-logos/servicios/01.webp", width: 220, surface: "dark" },
  { name: "ZG Mayoristas", logo: "/experience-logos/servicios/02.webp", width: 220 },
  { name: "GreenLink Tecnología y Seguridad", logo: "/experience-logos/servicios/03.webp", width: 220, surface: "dark" },
  { name: "Termotécnica Industrial", logo: "/experience-logos/servicios/04.webp", width: 220, surface: "dark" },
  { name: "Primer", logo: "/experience-logos/servicios/05.webp", width: 220, surface: "dark" },
  { name: "Greater Medellín Convention & Visitors Bureau", logo: "/experience-logos/servicios-publicos/01.webp", width: 220 },
  { name: "Gaz", logo: "/experience-logos/servicios-publicos/02.webp", width: 220 },
  { name: "Llanogas", logo: "/experience-logos/servicios-publicos/03.webp", width: 220, surface: "dark" },
  { name: "Cusianagas", logo: "/experience-logos/servicios-publicos/04.webp", width: 220, surface: "dark" },
  { name: "EPM", logo: "/experience-logos/servicios-publicos/05.webp", width: 220 },
  { name: "Biogás", logo: "/experience-logos/servicios-publicos/06.webp", width: 220 },
  { name: "Green Services and Solutions", logo: "/experience-logos/construccion/01.webp", width: 220, surface: "dark" },
  { name: "DKO", logo: "/experience-logos/construccion/02.webp", width: 220 },
  { name: "S2 Solpak", logo: "/experience-logos/construccion/03.webp", width: 220, surface: "dark" },
  { name: "López Grupo Constructor", logo: "/experience-logos/construccion/04.webp", width: 220, surface: "dark" },
  { name: "Prinza", logo: "/experience-logos/construccion/05.webp", width: 220, surface: "dark" },
  { name: "LBI", logo: "/experience-logos/bienes-raices/01.webp", width: 220 },
  { name: "Century 21", logo: "/experience-logos/bienes-raices/02.webp", width: 220 },
  { name: "Maxibienes", logo: "/experience-logos/bienes-raices/03.webp", width: 220 },
  { name: "Alquiler Argentina", logo: "/experience-logos/bienes-raices/04.webp", width: 220 },
  { name: "Sumeria Premium Homes", logo: "/experience-logos/bienes-raices/05.webp", width: 220, surface: "dark" },
  { name: "Grupo UMA", logo: "/experience-logos/automotriz/01.webp", width: 220 },
  { name: "Grupo Mayesa", logo: "/experience-logos/automotriz/02.webp", width: 220 },
  { name: "Autocor", logo: "/experience-logos/automotriz/03.webp", width: 220 },
  { name: "Autoland", logo: "/experience-logos/automotriz/04.webp", width: 220, surface: "dark" },
  { name: "Divemotor", logo: "/experience-logos/automotriz/05.webp", width: 220, surface: "dark" },
  { name: "Ambacar", logo: "/experience-logos/automotriz/06.webp", width: 220, surface: "dark" },
  { name: "Root+Co", logo: "/experience-logos/ecommerce/01.webp", width: 220, surface: "dark" },
  { name: "Fajitex", logo: "/experience-logos/ecommerce/02.webp", width: 220, surface: "dark" },
  { name: "PPA", logo: "/experience-logos/ecommerce/03.webp", width: 220 },
  { name: "Finca Urbana", logo: "/experience-logos/ecommerce/04.webp", width: 220 },
  { name: "Auros", logo: "/experience-logos/comercio/01.webp", width: 220 },
  { name: "Vanguard Logistics", logo: "/experience-logos/comercio/02.webp", width: 220 },
  { name: "Artesa", logo: "/experience-logos/comercio/03.webp", width: 220, surface: "dark" },
  { name: "PM Mayorista", logo: "/experience-logos/comercio/04.webp", width: 220 },
  { name: "NCredit", logo: "/experience-logos/servicios-financieros/01.webp", width: 220 },
  { name: "Servicios de Crédito", logo: "/experience-logos/servicios-financieros/02.webp", width: 220 },
  { name: "CrediNómina", logo: "/experience-logos/servicios-financieros/03.webp", width: 220 },
  { name: "ConSuerte", logo: "/experience-logos/servicios-financieros/04.webp", width: 220, surface: "dark" },
  { name: "Apoyo Crediticio", logo: "/experience-logos/servicios-financieros/05.webp", width: 220 },
  { name: "SCS Agency Insurance", logo: "/experience-logos/servicios-financieros/06.webp", width: 220 },
  { name: "Perseo", logo: "/experience-logos/software/01.webp", width: 220, surface: "dark" },
  { name: "Validatech", logo: "/experience-logos/software/02.webp", width: 220 },
  { name: "Globaltec", logo: "/experience-logos/software/03.webp", width: 220 },
  { name: "Prevsis", logo: "/experience-logos/software/04.webp", width: 220 },
  { name: "Bismark", logo: "/experience-logos/software/05.webp", width: 220, surface: "dark" },
  { name: "Fadesa", logo: "/experience-logos/manufactura/01.webp", width: 220 },
  { name: "902", logo: "/experience-logos/manufactura/02.webp", width: 220 },
  { name: "Algamar", logo: "/experience-logos/manufactura/03.webp", width: 220 },
  { name: "Link & Paper", logo: "/experience-logos/manufactura/04.webp", width: 220 },
  { name: "Forma", logo: "/experience-logos/manufactura/05.webp", width: 220, surface: "dark" },
  { name: "Sierras y Equipos", logo: "/experience-logos/manufactura/06.webp", width: 220 },
];
