    ...
    <div className="methodology-editorial-grid">
      {methodology.map((step, index) => (
        <article className="methodology-editorial-card" key={step.phase}>
          <div className="methodology-editorial-image" style={{ backgroundPosition: `${index * (100 / 3)}% center` }} role="img" aria-label={`Equipo de Workflow durante la fase de ${step.title.toLowerCase()}`} />
